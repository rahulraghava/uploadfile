...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post variants_url, params: { variant: { brand_id: @variant.brand_id, model: @variant.model } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { brand_id: @variant.brand_id, model: @variant.model } }
