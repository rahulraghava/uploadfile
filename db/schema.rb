...
ActiveRecord::Schema.define(version: 20180422174906) do
  ...
  create_table "advertisments", force: :cascade do |t|
    ...
    t.index ["brand_id"], name: "index_advertisments_on_brand_id"
    t.index ["user_id"], name: "index_advertisments_on_user_id"
    t.index ["variant_id"], name: "index_advertisments_on_variant_id"
  end
